...
const RequestSentProduct: React.FC<OfferData> = ({ data }) => {
                        ...
                        {item.type === 'cash' && (<>
                            <View style={styles.customer_info_container}>
                                ...
                                <View style={{ flex: 1, gap: 3 }}>
                                    <View style={styles.product_info_left} >
                                        <Text style={{ fontSize: fontSize.xm - 4, fontWeight: '600' }}>Product Price:</Text>
                                        <Text style={{ fontSize: fontSize.xm - 4, fontWeight: '600', }}>{item.product.product_price}</Text>
                                    </View>
                                    <View style={styles.product_info_left} >
                                        <Text style={{ fontSize: fontSize.xm - 4, fontWeight: '600' }}>Amount Offered:</Text>
                                        <Text style={{ fontSize: fontSize.xm - 4, fontWeight: '600', }}>{item.price_offered}</Text>
                                    </View>
                                    <View style={styles.product_info_left} >
                                        <Text style={{ fontSize: fontSize.xm - 4, fontWeight: '600' }}>Product Condition:</Text>
                                        <Text style={{ fontSize: fontSize.xm - 4, fontWeight: '600', }}>{item.product.product_condition}</Text>
                                    </View>
                                    <View style={styles.product_info_left}>
                            ...
                            <View style={styles.product_info}>
                                <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                                    <Text style={{ fontSize: fontSize.xm - 4, fontWeight: '600', position: 'absolute', zIndex: 1, top: 2 }}>
                                        {item.type !== 'cash' ? 'Your Item' : 'Cash Offered'}
                                    ...
                                    <View style={{ height: 70, width: 70, alignItems: 'center', justifyContent: 'center' }}>
                                        ...
                                        <Text style={{ fontWeight: '600', fontSize: 18 }}>₦{item.price_offered}</Text>
                                    </View>
                                </View>
...
export default RequestSentProduct
